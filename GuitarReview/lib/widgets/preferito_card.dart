...
class PreferitoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final chitarra = notifier.chitarraPer(preferito.chitarraId);
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(chitarra?.nome ?? '(Chitarra non trovata)',
  ...
  Future<void> _confermaElimina(
      BuildContext context, ChitarreNotifier notifier) async {
    final ok = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text('Rimuovi dai preferiti'),
        content: const Text('Vuoi rimuovere questa chitarra dai preferiti?'),
        actions: [
          TextButton(
